...
export default function QuizIceCream() {
  const navigate = useNavigate();

  // جلب الطفل النشط
  const childId = localStorage.getItem("activeChildId");

  const question = "What is the girl waiting for?";

  const options = [
    { id: 1, text: "A bus", isCorrect: false },
    { id: 2, text: "An ice-cream truck", isCorrect: true },
    { id: 3, text: "A dog", isCorrect: false },
  ];
